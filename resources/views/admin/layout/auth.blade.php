            ...
            <div class="user-info-dropdown">
                <div class="dropdown">
                    <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                        ...
                        <span class="user-name">zeyad</span>
                    </a>
        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <li>
                        <a href="{{ route('admin_category') }}" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-diagram-3"></span><span class="mtext">Categories</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin_order') }}" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-person-circle"></span><span class="mtext">ORDERS</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin_product') }}" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-table"></span><span class="mtext">Products</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin_contact') }}" class="dropdown-toggle no-arrow">
